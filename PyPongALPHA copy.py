...
audio_toggle_button = Toggle_Button(TOGGLE_ON, TOGGLE_OFF, 40, 141, audio_toggle)
...
def draw_options_menu(options_back_button, AdvancedPaddle_Toggle_button, audio_toggle_button, placeholder2_toggle_button, placeholder3_toggle_button, paddle_tbox_text):
	WIN.blit(MAIN_MENU_BACKGROUND, (0, 0))
	...
	draw_text('Music', (12, 111), font=FONT20, center='y')
	audio_toggle_button.update()
...
def get_reg_state(options_back_button, clicked_back):
	...
	return clicked_back
def get_toggle_state(AdvancedPaddle_Toggle_button, AdvancedPaddle_Toggle, audio_toggle_button, audio_toggle, placeholder2_toggle_button, placeholder2_toggle, placeholder3_toggle_button, placeholder3_toggle):
	AdvancedPaddle_Toggle = AdvancedPaddle_Toggle_button.checkForInput(pg.mouse.get_pos())
	audio_toggle = audio_toggle_button.checkForInput(pg.mouse.get_pos())
	...
	return AdvancedPaddle_Toggle, audio_toggle, placeholder2_toggle, placeholder3_toggle

def options_menu():
	global clicked_back, clicked_button, tball_vel, AdvancedPaddle_Toggle, audio_toggle, placeholder2_toggle,placeholder3_toggle, paddle_tbox_focus, paddle_tbox_text, VEL, ball_tbox_focus, ball_tbox_text, BALL_VEL
	...
	while run_options_menu:
		...
		for event in pg.event.get():
			...
			if event.type == pg.MOUSEBUTTONDOWN:
				...
				#toggles
				AdvancedPaddle_Toggle, audio_toggle, placeholder2_toggle, placeholder3_toggle = get_toggle_state(AdvancedPaddle_Toggle_button, AdvancedPaddle_Toggle, audio_toggle_button, audio_toggle, placeholder2_toggle_button, placeholder2_toggle, placeholder3_toggle_button, placeholder3_toggle)
				if audio_toggle:
					pg.mixer.music.set_volume(1)
				elif not audio_toggle:
		...
		draw_options_menu(options_back_button, AdvancedPaddle_Toggle_button, audio_toggle_button, placeholder2_toggle_button, placeholder3_toggle_button, paddle_tbox_text)
...
def timer1_sec():
	...
	while countdown_val > 0:
		...
		countdown_val_location.center = (450, 300)
...
def draw(lpaddle, rpaddle, ball, logo, lscore, rscore, pause):
	...
	WIN.blit(lscore, (424, 30))
	WIN.blit(rscore, (464, 30))
